...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id_tequio > 0 && !empty($descripcion)) {
        ...
        if ($result) {
            header("Location: /proyectocomunitario/public/index.php?page=tequios&msg=updated");
        } else {
            header("Location: /proyectocomunitario/public/index.php?page=tequios&error=update_failed");
        }
    } else {
        header("Location: /proyectocomunitario/public/index.php?page=tequios&error=invalid_data");
    }
} else {
